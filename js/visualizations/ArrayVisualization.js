...
export class ArrayVisualization extends Visualization {
  constructor(editor) {
    super(editor);
  ...
  init(initialArray) {
    ...
    for (let i = 0; i < this.arrayLength; i++) {
      ...
      bar.style.transition =
        "height var(--array-anim-speed, 0.3s) cubic-bezier(0.4, 0, 0.2, 1), background-color var(--array-anim-speed, 0.2s) ease, transform 0.1s ease";
